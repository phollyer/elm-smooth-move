...
var $author$project$SmoothMoveState$Basic$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'AnimationFrame':
				var deltaMs = msg.a;
...
var $author$project$SmoothMoveState$Basic$view = function (model) {
	var position = A2(
		$elm$core$Maybe$withDefault,
		{x: 150, y: 100},
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$SmoothMoveState$Basic$MoveToCorner)
							]),
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$SmoothMoveState$Basic$MoveToCenter),
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$SmoothMoveState$Basic$StopAnimation),
								A2($elm$html$Html$Attributes$style, 'margin-left', '10px')
							]),
						_List_fromArray(
							[
...
var $author$project$SmoothMoveCSS$Basic$init = function (_v0) {
	return _Utils_Tuple2(
		{animations: $author$project$SmoothMoveCSS$init},
		$elm$core$Platform$Cmd$none);
};
var $author$project$SmoothMoveCSS$Basic$subscriptions = function (model) {
	return $elm$core$Platform$Sub$none;
};
...
var $author$project$SmoothMoveCSS$Basic$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'MoveToCorner':
				return _Utils_Tuple2(
...
var $author$project$SmoothMoveCSS$Basic$view = function (model) {
	var position = A2(
		$elm$core$Maybe$withDefault,
		{x: 150, y: 100},
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$SmoothMoveCSS$Basic$MoveToCorner)
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('Move to Corner (300, 200)')
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$SmoothMoveCSS$Basic$MoveToCenter),
								A2($elm$html$Html$Attributes$style, 'margin-left', '10px')
							]),
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$SmoothMoveCSS$Basic$StopAnimation),
								A2($elm$html$Html$Attributes$style, 'margin-left', '10px')
							]),
						_List_fromArray(
							[

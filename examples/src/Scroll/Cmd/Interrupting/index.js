...
{
	if (region.a8.ap === region.bm.ap)
	{
		return 'on line ' + region.a8.ap;
	}
	return 'on lines ' + region.a8.ap + ' through ' + region.bm.ap;
}
...
var $author$project$Scroll$Cmd$Interrupting$Main$ScrollComplete = {$: 1};
...
var $author$project$Scroll$Internal$ScrollBuilder$init = {K: 0, af: $elm$core$Maybe$Nothing, aP: _List_Nil, at: $elm$core$Maybe$Nothing};
...
var $author$project$Scroll$Cmd$Interrupting$Main$scrollToElement = function (targetId) {
	return A2(
...
var $author$project$Scroll$Cmd$Interrupting$Main$update = F2(
	function (msg, model) {
		if (!msg.$) {
			var targetId = msg.a;
			return _Utils_Tuple2(
				...
				A2(
					...
					$author$project$Scroll$Cmd$Interrupting$Main$ScrollComplete,
					$author$project$Scroll$Cmd$Interrupting$Main$scrollToElement(targetId)));
		} else {
			return _Utils_Tuple2(
				_Utils_update(
					model,
...
var $author$project$Scroll$Cmd$Interrupting$Main$ScrollTo = function (a) {
	return {$: 0, a: a};
};
...
var $author$project$Scroll$Cmd$Interrupting$Main$filler = function (label) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
...
var $author$project$Scroll$Cmd$Interrupting$Main$spacer = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
	...
	_List_Nil);
var $author$project$Scroll$Cmd$Interrupting$Main$targetBlock = F3(
...
var $author$project$Scroll$Cmd$Interrupting$Main$scrollContent = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
	...
	_List_fromArray(
		[
			A3($author$project$Scroll$Cmd$Interrupting$Main$targetBlock, 'top-target', '🟢 Top Target', '#22c55e'),
			$author$project$Scroll$Cmd$Interrupting$Main$spacer,
			$author$project$Scroll$Cmd$Interrupting$Main$filler('Scroll through me…'),
			$author$project$Scroll$Cmd$Interrupting$Main$spacer,
			$author$project$Scroll$Cmd$Interrupting$Main$filler('…keep scrolling…'),
			$author$project$Scroll$Cmd$Interrupting$Main$spacer,
			A3($author$project$Scroll$Cmd$Interrupting$Main$targetBlock, 'bottom-target', '🔴 Bottom Target', '#ef4444')
		]));
var $author$project$Scroll$Cmd$Interrupting$Main$statusBar = function (active) {
...
var $author$project$Scroll$Cmd$Interrupting$Main$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
					...
					[
						...
						_List_fromArray(
							[
								...
								$author$project$Scroll$Cmd$Interrupting$Main$ScrollTo('top-target')),
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick(
								$author$project$Scroll$Cmd$Interrupting$Main$ScrollTo('bottom-target')),
				...
				$author$project$Scroll$Cmd$Interrupting$Main$statusBar(model.R),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
				...
				_List_fromArray(
					[$author$project$Scroll$Cmd$Interrupting$Main$scrollContent]))
			]));
};
var $author$project$Scroll$Cmd$Interrupting$Main$main = $elm$browser$Browser$element(
	{
		c0: function (_v0) {
			return _Utils_Tuple2(
				{R: 0},
		...
		ea: $author$project$Scroll$Cmd$Interrupting$Main$update,
		eb: $author$project$Scroll$Cmd$Interrupting$Main$view
	});
_Platform_export({'Scroll':{'Cmd':{'Interrupting':{'Main':{'init':$author$project$Scroll$Cmd$Interrupting$Main$main(

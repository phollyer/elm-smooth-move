...
var $author$project$Scroll$Task$Interrupting$Main$init = _Utils_Tuple2(
	{R: 0},
	$elm$core$Platform$Cmd$none);
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$core$Platform$Sub$none = $elm$core$Platform$Sub$batch(_List_Nil);
var $author$project$Scroll$Task$Interrupting$Main$ScrollResult = function (a) {
	return {$: 1, a: a};
};
...
var $author$project$Scroll$Internal$Engine$Task$buildConfig = function (scrollBuilder) {
	return {
		...
		af: $author$project$Shared$Easing$toFunction(
			A2(
				$elm$core$Maybe$withDefault,
...
var $author$project$Scroll$Internal$ScrollBuilder$init = {K: 0, af: $elm$core$Maybe$Nothing, aN: _List_Nil, as: $elm$core$Maybe$Nothing};
	...
	function (container, config, viewport, targetX, targetY) {
		...
		switch (_v0) {
			...
			default:
				...
				var xSteps = A4($author$project$Scroll$Internal$Engine$Task$createSteps, frames, config.af, viewport.s, targetX);
				var ySteps = A4($author$project$Scroll$Internal$Engine$Task$createSteps, frames, config.af, viewport.t, targetY);
...
var $author$project$Scroll$Internal$ScrollBuilder$setEasing = F2(
	function (easingFn, _v0) {
		...
		return _Utils_update(
			data,
			{
				af: $elm$core$Maybe$Just(easingFn)
			});
	});
...
var $author$project$Scroll$Task$Interrupting$Main$scrollToElement = function (targetId) {
	return A2(
		$elm$core$Basics$composeR,
...
var $author$project$Scroll$Task$Interrupting$Main$update = F2(
	function (msg, model) {
		if (!msg.$) {
			var targetId = msg.a;
			return _Utils_Tuple2(
				...
				A2(
					...
					$author$project$Scroll$Task$Interrupting$Main$ScrollResult,
					$author$project$Scroll$Engine$Task$scroll(
						$author$project$Scroll$Task$Interrupting$Main$scrollToElement(targetId))));
		} else {
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						R: A2($elm$core$Basics$max, 0, model.R - 1)
					}),
				$elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Scroll$Task$Interrupting$Main$ScrollTo = function (a) {
	return {$: 0, a: a};
};
...
var $author$project$Scroll$Task$Interrupting$Main$filler = function (label) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
...
var $author$project$Scroll$Task$Interrupting$Main$spacer = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
	...
	_List_Nil);
var $author$project$Scroll$Task$Interrupting$Main$targetBlock = F3(
...
var $author$project$Scroll$Task$Interrupting$Main$scrollContent = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
	...
	_List_fromArray(
		[
			A3($author$project$Scroll$Task$Interrupting$Main$targetBlock, 'top-target', '🟢 Top Target', '#22c55e'),
			$author$project$Scroll$Task$Interrupting$Main$spacer,
			$author$project$Scroll$Task$Interrupting$Main$filler('Scroll through me…'),
			$author$project$Scroll$Task$Interrupting$Main$spacer,
			$author$project$Scroll$Task$Interrupting$Main$filler('…keep scrolling…'),
			$author$project$Scroll$Task$Interrupting$Main$spacer,
			A3($author$project$Scroll$Task$Interrupting$Main$targetBlock, 'bottom-target', '🔴 Bottom Target', '#ef4444')
		]));
var $author$project$Scroll$Task$Interrupting$Main$statusBar = function (active) {
	var _v0 = (!active) ? _Utils_Tuple2('#94a3b8', 'Idle — try clicking one button, then the other before it finishes') : ((active === 1) ? _Utils_Tuple2('#3b82f6', '1 scroll running') : _Utils_Tuple2(
		'#ef4444',
		$elm$core$String$fromInt(active) + ' scrolls running in parallel — they will compete'));
	var color = _v0.a;
	var message = _v0.b;
	return A2(
		$elm$html$Html$div,
...
var $author$project$Scroll$Task$Interrupting$Main$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
					...
					[
						...
						_List_fromArray(
							[
								...
								$author$project$Scroll$Task$Interrupting$Main$ScrollTo('top-target')),
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick(
								$author$project$Scroll$Task$Interrupting$Main$ScrollTo('bottom-target')),
				...
				$author$project$Scroll$Task$Interrupting$Main$statusBar(model.R),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
				...
				_List_fromArray(
					[$author$project$Scroll$Task$Interrupting$Main$scrollContent]))
			]));
};
var $author$project$Scroll$Task$Interrupting$Main$main = $elm$browser$Browser$element(
	{
		c0: function (_v0) {
			return $author$project$Scroll$Task$Interrupting$Main$init;
		},
		dO: $elm$core$Basics$always($elm$core$Platform$Sub$none),
		ea: $author$project$Scroll$Task$Interrupting$Main$update,
		eb: $author$project$Scroll$Task$Interrupting$Main$view
	});
_Platform_export({'Scroll':{'Task':{'Interrupting':{'Main':{'init':$author$project$Scroll$Task$Interrupting$Main$main(

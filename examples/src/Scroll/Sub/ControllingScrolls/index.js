...
{
	if (region.bk.aD === region.by.aD)
	{
		return 'on line ' + region.bk.aD;
	}
	return 'on lines ' + region.bk.aD + ' through ' + region.by.aD;
}
		...
		var _v1 = A3(
			...
			F3(
				function (scrollId, scrollAnim, _v2) {
					...
					var accEvents = _v2.b;
					return (A2($author$project$Scroll$Internal$Engine$Sub$containerMatches, containerId, scrollAnim.c.h) && (!scrollAnim.u)) ? _Utils_Tuple2(
						A3(
				...
				function (scrollId, scrollAnim, _v2) {
					...
					if (A2($author$project$Scroll$Internal$Engine$Sub$containerMatches, containerId, scrollAnim.c.h)) {
						var updatedScroll = _Utils_update(
							scrollAnim,
							{G: scrollAnim.D, H: scrollAnim.E, ae: scrollAnim.as === 0.0, B: 0.0, u: true, R: 0.0});
						var scrollCmd = A2(
							$elm$core$Task$attempt,
							function (_v3) {
								return toMsg($author$project$Scroll$Internal$Engine$Sub$NoOp);
							},
							A3($author$project$Scroll$Internal$Shared$Dom$setViewport, scrollAnim.c.h, scrollAnim.D, scrollAnim.E));
			...
			F3(
				function (scrollId, scrollAnim, _v2) {
					...
					if (A2($author$project$Scroll$Internal$Engine$Sub$containerMatches, containerId, scrollAnim.c.h)) {
						var updatedScroll = _Utils_update(
							scrollAnim,
							{G: scrollAnim.D, H: scrollAnim.E, ae: scrollAnim.as === 0.0, B: 0.0, u: false, R: 0.0});
						var scrollCmd = A2(
							$elm$core$Task$attempt,
							function (_v3) {
								return toMsg($author$project$Scroll$Internal$Engine$Sub$NoOp);
							...
							A3(
								...
								F2(
									function (viewport, containerEl) {
										return {aO: containerEl, a0: $elm$core$Maybe$Nothing, t: viewport};
									}),
								$author$project$Scroll$Internal$Shared$Dom$getViewport(container),
								$author$project$Scroll$Internal$Shared$Dom$getContainerInfo(container)));
					}
		...
		var _v1 = A3(
			...
			F3(
				function (scrollId, scrollAnim, _v2) {
					...
					var accEvents = _v2.c;
					if (A2($author$project$Scroll$Internal$Engine$Sub$containerMatches, containerId, scrollAnim.c.h)) {
						var stoppedScroll = _Utils_update(
							scrollAnim,
							{G: scrollAnim.c.al, H: scrollAnim.c.am, B: scrollAnim.aC, u: true, R: 1.0});
						var scrollCmd = A2(
							$elm$core$Task$attempt,
							function (_v3) {
								return toMsg($author$project$Scroll$Internal$Engine$Sub$NoOp);
							},
							A3($author$project$Scroll$Internal$Shared$Dom$setViewport, scrollAnim.c.h, scrollAnim.c.al, scrollAnim.c.am));
						var cid = $author$project$Scroll$Internal$Engine$Sub$containerToString(scrollAnim.c.h);
						return _Utils_Tuple3(
							A3($elm$core$Dict$insert, scrollId, stoppedScroll, accScrolls),
							A2($elm$core$List$cons, scrollCmd, accCmds),
							_Utils_ap(
								accEvents,
								_List_fromArray(
	...
	function (scrollBuilder, scrollTarget, domResult, element) {
		...
		var elementContentPosition = function () {
			...
			if (!_v3.$) {
				...
				return {d: ((element.at.d - containerEl.at.d) + viewport.t.d) - offsetX, e: ((element.at.e - containerEl.at.e) + viewport.t.e) - offsetY};
			} else {
				return {d: (element.at.d + viewport.t.d) - offsetX, e: (element.at.e + viewport.t.e) - offsetY};
			}
		}();
		...
		return {c: config, G: startPosition.d, H: startPosition.e, ae: delayMs === 0.0, as: delayMs, aC: actualDuration, B: 0.0, u: false, R: 0.0, D: startPosition.d, E: startPosition.e};
	});
...
var $author$project$Scroll$Internal$Engine$Sub$updateScrollAnimation = F2(
	function (deltaMs, animation) {
		if (!animation.ae) {
			var newElapsedMs = animation.B + deltaMs;
			return (_Utils_cmp(newElapsedMs, animation.as) > -1) ? _Utils_update(
				animation,
				{ae: true, B: 0.0}) : _Utils_update(
				animation,
				{B: newElapsedMs});
		} else {
			var newElapsedMs = animation.B + deltaMs;
			...
			var newCurrentX = function () {
				...
				if (_v1 === 1) {
					...
					return animation.D + ((animation.c.al - animation.D) * easedProgress);
				}
			}();
			var newCurrentY = function () {
				...
				if (!_v0) {
					...
					return animation.E + ((animation.c.am - animation.E) * easedProgress);
				}
			}();
			return _Utils_update(
				animation,
				{G: newCurrentX, H: newCurrentY, B: newElapsedMs, R: progress});
		}
	});
	...
	function (fromInternalEvent, toMsg, msg, _v0) {
		...
		switch (msg.$) {
			...
			case 1:
				...
				var hasDistance = A5($author$project$Scroll$Internal$Engine$Sub$calculateDistance, scrollAnimation.c.ab, scrollAnimation.D, scrollAnimation.E, scrollAnimation.c.al, scrollAnimation.c.am) > 0;
...
var $author$project$Scroll$Sub$ControllingScrolls$Main$main = $elm$browser$Browser$element(
	{
		dg: function (_v0) {
			return $author$project$Scroll$Sub$ControllingScrolls$Main$init;
		},

...
var $author$project$Anim$Internal$Builder$initDefaults = {V: $author$project$Anim$Internal$Builder$CssUnitStore$empty, h: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aq: $elm$core$Maybe$Nothing, ar: $elm$core$Maybe$Nothing, R: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aB: $elm$core$Maybe$Nothing, aa: $elm$core$Maybe$Nothing, aC: $elm$core$Maybe$Nothing, aE: $elm$core$Maybe$Nothing, aI: $elm$core$Maybe$Nothing, b1: $elm$core$Set$empty, au: $elm$core$Maybe$Nothing};
...
var $author$project$Anim$Internal$Builder$initState = {aw: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, L: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aW: $elm$core$Dict$empty, bV: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
	...
	var resetInitEntryScope = function (_v0) {
		...
		return _Utils_update(
			data,
			{
				...
				c: _Utils_update(
					defs,
					{aE: $elm$core$Maybe$Nothing, aI: $elm$core$Maybe$Nothing, au: $elm$core$Maybe$Nothing})
			});
	};
	var runInitEntry = F2(
		function (f, builder) {
	...
	return wrapper(
		{
			...
			s: A3($author$project$Anim$Internal$Builder$resolveDelayWithDefault, config.s, globalData.aq, 0),
			cc: distance_,
				...
				function (animGroupName, groupConfig, _v1) {
					...
					var updatedHistory = function () {
						if (existingHistory.$ === 1) {
							return {aA: newEntry, a7: _List_Nil};
						} else {
							var existing = existingHistory.a;
							return {
								aA: newEntry,
								a7: A2($elm$core$List$cons, existing.aA, existing.a7)
							};
						}
					}();
					return _Utils_update(
		...
		var initialPlayStateFor = function (animGroupName) {
			return A2(
				...
				A2(
					...
					A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, processedAnimData.cf)));
		};
			...
			function (h) {
				...
				return function (result) {
					if (!result.$) {
						...
						return $elm$core$Maybe$Just(h.aA.D);
					}
				}(
					A2(
						$elm$core$Maybe$map,
						...
						$elm$core$List$head(
							A2(
								$elm$core$List$filter,
								isAnimate,
								A2($elm$core$List$cons, h.aA, h.a7)))));
			},
			A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, data.u.aw));
	});

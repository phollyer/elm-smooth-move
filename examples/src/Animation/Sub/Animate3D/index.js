...
var $author$project$Animation$Sub$Animate3D$Main$backFace = {
	...
	I: 'back-face',
	K: 'BACK',
	t: {aH: 'rgb(0,0,0)', n: 'backFaceTextAnim', I: 'back-face-text', K: 'BACK'}
};
var $author$project$Animation$Sub$Animate3D$Main$bottomFace = {
	...
	I: 'bottom-face',
	K: 'BOTTOM',
	t: {aH: 'rgb(0,0,0)', n: 'bottomFaceTextAnim', I: 'bottom-face-text', K: 'BOTTOM'}
};
...
var $author$project$Animation$Sub$Animate3D$Main$frontFace = {
	...
	I: 'front-face',
	K: 'FRONT',
	t: {aH: 'rgb(0,0,0)', n: 'frontFaceTextAnim', I: 'front-face-text', K: 'FRONT'}
};
...
var $author$project$Anim$Internal$Builder$initDefaults = {ad: $author$project$Anim$Internal$Builder$CssUnitStore$empty, h: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, ax: $elm$core$Maybe$Nothing, ay: $elm$core$Maybe$Nothing, _: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aL: $elm$core$Maybe$Nothing, aj: $elm$core$Maybe$Nothing, aM: $elm$core$Maybe$Nothing, aO: $elm$core$Maybe$Nothing, aR: $elm$core$Maybe$Nothing, cc: $elm$core$Set$empty, aB: $elm$core$Maybe$Nothing};
...
var $author$project$Anim$Internal$Builder$initState = {aD: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, V: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, a2: $elm$core$Dict$empty, b5: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
	...
	var resetInitEntryScope = function (_v0) {
		...
		return _Utils_update(
			data,
			{
				...
				c: _Utils_update(
					defs,
					{aO: $elm$core$Maybe$Nothing, aR: $elm$core$Maybe$Nothing, aB: $elm$core$Maybe$Nothing})
			});
	};
	var runInitEntry = F2(
		function (f, builder) {
	...
	return wrapper(
		{
			...
			u: A3($author$project$Anim$Internal$Builder$resolveDelayWithDefault, config.u, globalData.ax, 0),
			cp: distance_,
...
var $author$project$Animation$Sub$Animate3D$Main$leftFace = {
	...
	I: 'left-face',
	K: 'LEFT',
	t: {aH: 'rgb(0,0,0)', n: 'leftFaceTextAnim', I: 'left-face-text', K: 'LEFT'}
};
var $author$project$Animation$Sub$Animate3D$Main$rightFace = {
	...
	I: 'right-face',
	K: 'RIGHT',
	t: {aH: 'rgb(0,0,0)', n: 'rightFaceTextAnim', I: 'right-face-text', K: 'RIGHT'}
};
...
var $author$project$Animation$Sub$Animate3D$Main$topFace = {
	...
	I: 'top-face',
	K: 'TOP',
	t: {aH: 'rgb(0,0,0)', n: 'topFaceTextAnim', I: 'top-face-text', K: 'TOP'}
};
				...
				function (animGroupName, groupConfig, _v1) {
					...
					var updatedHistory = function () {
						if (existingHistory.$ === 1) {
							return {aK: newEntry, be: _List_Nil};
						} else {
							var existing = existingHistory.a;
							return {
								aK: newEntry,
								be: A2($elm$core$List$cons, existing.aK, existing.be)
							};
						}
					}();
					return _Utils_update(
	...
	function (iterationCount, directionConfig, maybeOrder, discreteEntryProps, discreteExitProps, existingAnimation, properties) {
		...
		var hasAnimateTiming = A2(
			...
			function (prop) {
				...
				return (timing.x > 0) || (timing.u > 0);
			},
			$author$project$Anim$Internal$Builder$partitionByMode(adjustedProperties).bb);
...
var $author$project$Anim$Internal$Builder$getCurrentAnimationConfig = F2(
	function (animGroupName, _v0) {
		...
		return A2(
			...
			A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, data.w.aD));
	});
			...
			_Utils_ap(
				...
				_List_fromArray(
					[
						...
						A2($elm$html$Html$Attributes$style, 'background-color', config.aF),
						A2($elm$html$Html$Attributes$style, 'border', '2px solid ' + config.aG),
					...
					_Utils_ap(
						...
						_List_fromArray(
							[
								...
								A2($elm$html$Html$Attributes$style, 'color', config.t.aH),
								A2($elm$html$Html$Attributes$style, 'position', 'absolute')
							])),
					_List_fromArray(
						[

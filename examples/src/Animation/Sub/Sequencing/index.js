...
var $author$project$Animation$Sub$Sequencing$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Engine$Sub$subscriptions, $author$project$Animation$Sub$Sequencing$Main$GotSubMsg, model.az);
};
				...
				[
					...
					_List_fromArray(
						[
							...
							$elm$html$Html$div,
							_Utils_ap(
								A2($author$project$Anim$Engine$Sub$attributes, groupName, model.az),
								_List_fromArray(
									[

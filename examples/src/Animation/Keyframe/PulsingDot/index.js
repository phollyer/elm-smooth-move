				...
				function (animGroupName, groupConfig, _v1) {
					...
					var updatedHistory = function () {
						if (existingHistory.$ === 1) {
							return {aw: newEntry, a3: _List_Nil};
						} else {
							var existing = existingHistory.a;
							return {
								aw: newEntry,
								a3: A2($elm$core$List$cons, existing.aw, existing.a3)
							};
						}
					}();
	...
	function (finaliseBuilder, _v0, transform) {
		...
		var hasAnimateTiming = function (config) {
			return A2(
				...
				$author$project$Anim$Internal$Builder$partitionByMode(config.q).a$);
		};
...
var $author$project$Anim$Internal$Builder$initDefaults = {U: $author$project$Anim$Internal$Builder$CssUnitStore$empty, h: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, an: $elm$core$Maybe$Nothing, ao: $elm$core$Maybe$Nothing, R: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, ax: $elm$core$Maybe$Nothing, _: $elm$core$Maybe$Nothing, ay: $elm$core$Maybe$Nothing, aA: $elm$core$Maybe$Nothing, aD: $elm$core$Maybe$Nothing, b_: $elm$core$Set$empty, ar: $elm$core$Maybe$Nothing};
...
var $author$project$Anim$Internal$Builder$initState = {as: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, L: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aS: $elm$core$Dict$empty, bT: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};

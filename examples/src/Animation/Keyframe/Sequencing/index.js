...
var $author$project$Animation$Keyframe$Sequencing$Main$init = _Utils_Tuple2(
	{
		as: $author$project$Anim$Engine$Keyframe$init(
			_List_fromArray(
				[
		...
		return A2(
			...
			function (defs) {
				return _Utils_update(
					defs,
					{
						ao: $elm$core$Maybe$Just(easingValue),
...
var $author$project$Animation$Keyframe$Sequencing$Main$update = F2(
	function (msg, model) {
		if (!msg.$) {
			...
			var _v1 = A2($author$project$Anim$Engine$Keyframe$update, keyframeMsg, model.as);
				...
				[
					...
					_List_fromArray(
						[
							...
							$elm$html$Html$div,
							_Utils_ap(
								A2($author$project$Anim$Engine$Keyframe$attributes, groupName, model.as),
								_Utils_ap(

...
var $author$project$Animation$WAAPI$Animate3D$Main$backFace = {
	...
	L: 'back-face',
	N: 'BACK',
	v: {aK: 'rgb(0,0,0)', o: 'backFaceTextAnim', L: 'back-face-text', N: 'BACK'}
};
var $author$project$Animation$WAAPI$Animate3D$Main$bottomFace = {
	...
	L: 'bottom-face',
	N: 'BOTTOM',
	v: {aK: 'rgb(0,0,0)', o: 'bottomFaceTextAnim', L: 'bottom-face-text', N: 'BOTTOM'}
};
...
var $author$project$Animation$WAAPI$Animate3D$Main$frontFace = {
	...
	L: 'front-face',
	N: 'FRONT',
	v: {aK: 'rgb(0,0,0)', o: 'frontFaceTextAnim', L: 'front-face-text', N: 'FRONT'}
};
...
var $author$project$Anim$Internal$Builder$initDefaults = {ae: $author$project$Anim$Internal$Builder$CssUnitStore$empty, i: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aA: $elm$core$Maybe$Nothing, aB: $elm$core$Maybe$Nothing, ab: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aO: $elm$core$Maybe$Nothing, ak: $elm$core$Maybe$Nothing, aP: $elm$core$Maybe$Nothing, aW: $elm$core$Maybe$Nothing, aZ: $elm$core$Maybe$Nothing, cl: $elm$core$Set$empty, aE: $elm$core$Maybe$Nothing};
...
var $author$project$Anim$Internal$Builder$initState = {aG: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, W: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, ba: $elm$core$Dict$empty, cd: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
	...
	var resetInitEntryScope = function (_v0) {
		...
		return _Utils_update(
			data,
			{
				...
				c: _Utils_update(
					defs,
					{aW: $elm$core$Maybe$Nothing, aZ: $elm$core$Maybe$Nothing, aE: $elm$core$Maybe$Nothing})
			});
	};
	var runInitEntry = F2(
		function (f, builder) {
	...
	return wrapper(
		{
			...
			x: A3($author$project$Anim$Internal$Builder$resolveDelayWithDefault, config.x, globalData.aA, 0),
			cx: distance_,
...
var $author$project$Animation$WAAPI$Animate3D$Main$leftFace = {
	...
	L: 'left-face',
	N: 'LEFT',
	v: {aK: 'rgb(0,0,0)', o: 'leftFaceTextAnim', L: 'left-face-text', N: 'LEFT'}
};
...
var $author$project$Animation$WAAPI$Animate3D$Main$rightFace = {
	...
	L: 'right-face',
	N: 'RIGHT',
	v: {aK: 'rgb(0,0,0)', o: 'rightFaceTextAnim', L: 'right-face-text', N: 'RIGHT'}
};
...
var $author$project$Animation$WAAPI$Animate3D$Main$topFace = {
	...
	L: 'top-face',
	N: 'TOP',
	v: {aK: 'rgb(0,0,0)', o: 'topFaceTextAnim', L: 'top-face-text', N: 'TOP'}
};
				...
				function (animGroupName, groupConfig, _v1) {
					...
					var updatedHistory = function () {
						if (existingHistory.$ === 1) {
							return {aN: newEntry, bn: _List_Nil};
						} else {
							var existing = existingHistory.a;
							return {
								aN: newEntry,
								bn: A2($elm$core$List$cons, existing.aN, existing.bn)
							};
						}
					}();
					return _Utils_update(
...
var $author$project$Anim$Internal$Engine$WAAPI$AnimationUpdate = F5(
	function (animGroupName, progress, isAnimating, propertyVersions, propertyProgress) {
		return {aF: animGroupName, de: isAnimating, aa: progress, dz: propertyProgress, cI: propertyVersions};
	});
...
var $author$project$Anim$Internal$Builder$getCurrentAnimationConfig = F2(
	function (animGroupName, _v0) {
		...
		return A2(
			...
			A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, data.z.aG));
	});
				...
				case 'propertyUpdate':
					...
					if (!_v4.$) {
						...
						var updatedAnimations = A3(
							...
							animGroups);
						var shouldEmitProgress = A2($author$project$Anim$Internal$Builder$getEmitProgressFor, animUpdate.aF, state.r);
						var progressEvent = shouldEmitProgress ? $elm$core$Maybe$Just(
							A2($author$project$Anim$Internal$Engine$WAAPI$Progress, animUpdate.aF, animUpdate.aa)) : $elm$core$Maybe$Nothing;
...
var $author$project$Anim$Internal$Builder$getAnimationConfigs = F2(
	function (animGroupName, _v0) {
		var data = _v0;
		var _v1 = A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, data.z.aG);
		if (_v1.$ === 1) {
			return _List_Nil;
		} else {
			var h = _v1.a;
			return A2(
				...
				A2($elm$core$List$cons, h.aN, h.bn));
		}
	});
			...
			_Utils_ap(
				...
				_List_fromArray(
					[
						...
						A2($elm$html$Html$Attributes$style, 'background-color', config.aI),
						A2($elm$html$Html$Attributes$style, 'border', '2px solid ' + config.aJ),
					...
					_Utils_ap(
						...
						_List_fromArray(
							[
								...
								A2($elm$html$Html$Attributes$style, 'color', config.v.aK),
								A2($elm$html$Html$Attributes$style, 'position', 'absolute')
							])),
					_List_fromArray(
						[

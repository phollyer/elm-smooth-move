...
var $author$project$Animation$WAAPI$Sequencing$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Engine$WAAPI$subscriptions, $author$project$Animation$WAAPI$Sequencing$Main$GotWaapiMsg, model.aC);
};
				...
				[
					...
					_List_fromArray(
						[
							...
							$elm$html$Html$div,
							_Utils_ap(
								A2($author$project$Anim$Engine$WAAPI$attributes, groupName, model.aC),
								_List_fromArray(
									[

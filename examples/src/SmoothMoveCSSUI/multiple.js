...
var $author$project$SmoothMoveCSSUI$Multiple$viewContent = function (model) {
	...
	return _List_fromArray(
		[
			...
			_List_fromArray(
				[
					A3($author$project$Common$UI$actionButton, $author$project$Common$UI$Primary, $author$project$SmoothMoveCSSUI$Multiple$ScatterElements, 'Scatter'),
					A3($author$project$Common$UI$actionButton, $author$project$Common$UI$Success, $author$project$SmoothMoveCSSUI$Multiple$CircleFormation, 'Circle Formation'),
					A3($author$project$Common$UI$actionButton, $author$project$Common$UI$Purple, $author$project$SmoothMoveCSSUI$Multiple$ResetPositions, 'Reset')
				])),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(

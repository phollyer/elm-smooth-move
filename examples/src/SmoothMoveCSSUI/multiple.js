	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$text('SmoothMoveCSS Multiple Example')),
				A2(
				$mdgriffith$elm_ui$Element$el,
				_List_fromArray(
					[
				...
				$mdgriffith$elm_ui$Element$text('ElmUI Version - Hardware accelerated multiple element animations')),
				A2(
				$mdgriffith$elm_ui$Element$el,
				_List_fromArray(
					[
				...
				$mdgriffith$elm_ui$Element$text('🚀 All animations hardware accelerated by browser')),
				A2(
				$mdgriffith$elm_ui$Element$column,
				_List_fromArray(
					[
							...
							[
								...
								_List_fromArray(
									[
										...
										$mdgriffith$elm_ui$Element$text('CSS Transition')),
										A2(
										$mdgriffith$elm_ui$Element$el,
										_List_fromArray(
											[
				...
				_List_fromArray(
					[
							...
							]),
						{
							...
							onPress: $elm$core$Maybe$Just($author$project$SmoothMoveCSSUI$Multiple$ScatterElements)
						}),
						A2(
						$mdgriffith$elm_ui$Element$Input$button,
						_List_fromArray(
							...
							]),
						{
							...
							onPress: $elm$core$Maybe$Just($author$project$SmoothMoveCSSUI$Multiple$CircleFormation)
						}),
						A2(
						$mdgriffith$elm_ui$Element$Input$button,
						_List_fromArray(
							...
							]),
						{
							...
							onPress: $elm$core$Maybe$Just($author$project$SmoothMoveCSSUI$Multiple$ResetPositions)
						})
					])),
				A2(
				$mdgriffith$elm_ui$Element$el,
				...
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Element$text('Native CSS transitions - no animation frame subscriptions needed')),
						A2(
						$mdgriffith$elm_ui$Element$el,
						_List_fromArray(
							[
						...
						$mdgriffith$elm_ui$Element$text('Browser automatically optimizes for device performance & battery'))
					]))
			]));
};

		...
		[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							A3($author$project$Common$UI$actionButton, $author$project$Common$UI$Primary, $author$project$SmoothMovePortsUI$Multiple$Scatter, 'Scatter'),
							A3($author$project$Common$UI$actionButton, $author$project$Common$UI$Success, $author$project$SmoothMovePortsUI$Multiple$Circle, 'Circle Formation'),
							A3($author$project$Common$UI$actionButton, $author$project$Common$UI$Purple, $author$project$SmoothMovePortsUI$Multiple$Reset, 'Reset')
						]))
				])),
			A2(
			$mdgriffith$elm_ui$Element$el,

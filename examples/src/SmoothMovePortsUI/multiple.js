	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$text('SmoothMovePorts Multiple Example')),
				A2(
				$mdgriffith$elm_ui$Element$el,
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
									...
									]),
								{
									...
									onPress: $elm$core$Maybe$Just($author$project$SmoothMovePortsUI$Multiple$Scatter)
								}),
								A2(
								$mdgriffith$elm_ui$Element$Input$button,
								_List_fromArray(
									...
									]),
								{
									...
									onPress: $elm$core$Maybe$Just($author$project$SmoothMovePortsUI$Multiple$Circle)
								}),
								A2(
								$mdgriffith$elm_ui$Element$Input$button,
								_List_fromArray(
									...
									]),
								{
									...
									onPress: $elm$core$Maybe$Just($author$project$SmoothMovePortsUI$Multiple$Reset)
								})
							]))
					])),
				A2(
				...
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Element$text('Web Animations API with real-time position feedback')),
						A2(
						$mdgriffith$elm_ui$Element$el,
						_List_fromArray(
							[
						...
						$mdgriffith$elm_ui$Element$text('Advanced animation orchestration via Elm ports')),
						A2(
						$mdgriffith$elm_ui$Element$el,
						_List_fromArray(
							[
						...
						$mdgriffith$elm_ui$Element$text('⚠️ Requires smooth-move-ports.js to be loaded'))
					]))
			]));
};

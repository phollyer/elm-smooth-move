	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$text('SmoothMoveSub Multiple Example')),
				A2(
				$mdgriffith$elm_ui$Element$column,
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
							...
							]),
						{
							...
							onPress: $elm$core$Maybe$Just($author$project$SmoothMoveSubUI$Multiple$ScatterElements)
						}),
						A2(
						$mdgriffith$elm_ui$Element$Input$button,
						_List_fromArray(
							...
							]),
						{
							...
							onPress: $elm$core$Maybe$Just($author$project$SmoothMoveSubUI$Multiple$CircleFormation)
						}),
						A2(
						$mdgriffith$elm_ui$Element$Input$button,
						_List_fromArray(
							...
							]),
						{
							...
							onPress: $elm$core$Maybe$Just($author$project$SmoothMoveSubUI$Multiple$ResetPositions)
						})
					])),
				A2(
				$mdgriffith$elm_ui$Element$el,
	...
	return {
		body: _List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text($author$project$SmoothMoveSubUI$Multiple$responsiveCSS)
					])),
				A2(

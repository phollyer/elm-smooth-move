...
var $author$project$SmoothMoveStateUI$Basic$viewContent = function (model) {
	...
	return _List_fromArray(
		[
			...
			_List_fromArray(
				[
					A3($author$project$Common$UI$actionButton, $author$project$Common$UI$Primary, $author$project$SmoothMoveStateUI$Basic$MoveToCorner, 'Move to (100, 100)'),
					A3($author$project$Common$UI$actionButton, $author$project$Common$UI$Success, $author$project$SmoothMoveStateUI$Basic$MoveToCenter, 'Move to (300, 200)'),
					A3($author$project$Common$UI$actionButton, $author$project$Common$UI$Purple, $author$project$SmoothMoveStateUI$Basic$StopAnimation, 'Return to Origin')
				])),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(

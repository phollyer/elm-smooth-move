...
var $author$project$SmoothMovePorts$Multiple$AnimateInSequence = {$: 'AnimateInSequence'};
var $author$project$SmoothMovePorts$Multiple$AnimateToCenter = {$: 'AnimateToCenter'};
var $author$project$SmoothMovePorts$Multiple$AnimateToCorners = {$: 'AnimateToCorners'};
var $author$project$SmoothMovePorts$Multiple$StopAll = {$: 'StopAll'};
...
var $author$project$SmoothMovePorts$Multiple$animatedBox = F3(
...
var $author$project$SmoothMovePorts$Multiple$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$SmoothMovePorts$Multiple$AnimateToCorners),
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$SmoothMovePorts$Multiple$AnimateToCenter),
								A2($elm$html$Html$Attributes$style, 'margin-right', '10px'),
								A2($elm$html$Html$Attributes$style, 'padding', '10px 15px'),
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$SmoothMovePorts$Multiple$AnimateInSequence),
								A2($elm$html$Html$Attributes$style, 'margin-right', '10px'),
								A2($elm$html$Html$Attributes$style, 'padding', '10px 15px'),
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$SmoothMovePorts$Multiple$StopAll),
								A2($elm$html$Html$Attributes$style, 'padding', '10px 15px'),
				...
				_List_fromArray(
					[
						...
						A3($author$project$SmoothMovePorts$Multiple$animatedBox, 'box4', '#96CEB4', model.animations)
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
...
var $author$project$SmoothMovePorts$Multiple$main = $elm$browser$Browser$element(
	{init: $author$project$SmoothMovePorts$Multiple$init, subscriptions: $author$project$SmoothMovePorts$Multiple$subscriptions, update: $author$project$SmoothMovePorts$Multiple$update, view: $author$project$SmoothMovePorts$Multiple$view});
_Platform_export({'SmoothMovePorts':{'Multiple':{'init':$author$project$SmoothMovePorts$Multiple$main(

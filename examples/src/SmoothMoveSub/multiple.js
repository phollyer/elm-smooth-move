...
var $author$project$SmoothMoveSub$Multiple$subscriptions = function (model) {
	return A2($author$project$SmoothMoveSub$subscriptions, model.smoothMove, $author$project$SmoothMoveSub$Multiple$AnimationFrame);
};
...
var $author$project$SmoothMoveSub$Multiple$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'StartElementA':
...
var $author$project$SmoothMoveSub$Multiple$StartAll = {$: 'StartAll'};
var $author$project$SmoothMoveSub$Multiple$StartElementA = {$: 'StartElementA'};
var $author$project$SmoothMoveSub$Multiple$StartElementB = {$: 'StartElementB'};
var $author$project$SmoothMoveSub$Multiple$StartElementC = {$: 'StartElementC'};
...
var $author$project$SmoothMoveSub$Multiple$view = function (model) {
	var getTransform = F3(
...
var $author$project$SmoothMoveSub$Multiple$main = $elm$browser$Browser$document(
	{init: $author$project$SmoothMoveSub$Multiple$init, subscriptions: $author$project$SmoothMoveSub$Multiple$subscriptions, update: $author$project$SmoothMoveSub$Multiple$update, view: $author$project$SmoothMoveSub$Multiple$view});
_Platform_export({'SmoothMoveSub':{'Multiple':{'init':$author$project$SmoothMoveSub$Multiple$main(
